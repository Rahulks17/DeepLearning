...
def bipolarSv(request):
    ...
    ptext = '<font size="12">We have generated the report of <b> %s</b>, we found that your risk of %s is \
        =<b>%s</b>, we recommend you to take care of your health, because your this health will\
        help you to live a happy life. We are attaching your report here</font>' % (reportof1,reportof1,detail)
    ...
    Story.append(Paragraph(ptext, styles["Justify"]))
    Story.append(Spacer(1, 12))
    ptext = '<font size="12">Thank you so much and we are looking forward to serve you.</font>'
    Story.append(Paragraph(ptext, styles["Justify"]))
    Story.append(Spacer(1, 12))
